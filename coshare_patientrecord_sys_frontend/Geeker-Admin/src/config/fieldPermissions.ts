...
export const labReportRecordFields: RecordField[] = [
  ...
  { key: "coagulation", label: "凝血四项报告摘要", value: "", kind: "textarea", editors: labReportEditors },
  { key: "coagulationStatus", label: "凝血四项状态", value: "", kind: "select", editors: labReportEditors },
  { key: "lab_coagulation_pt", label: "PT", value: "", kind: "input", inputType: "number", editors: labReportEditors },
